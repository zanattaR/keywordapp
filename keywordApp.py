...
st.write('''Esta aplicação tem como objetivo encontrar possíveis Keywords e sua densidade
 na longa descrição dos aplicativos da Play Store.''')
...
stops.extend(['pra','h2','vc','dá','todo','tá','pode','on','line','https','poderá','www','aqui'])
...
if st.checkbox('Head Tail'):
	st.write(headTail)
	st.write('Número de palavras no texto:',wds)
	st.write('Densidade = Keyword / Número de Palavras')

########## Short Tail ##########
co_short = CountVectorizer(ngram_range=(2,2))
